...
# Kita gunakan model yang sudah di fine-tune di 16kHz
WAV2VEC2_MODEL_NAME = "facebook/wav2vec2-base-960h"
# Path output untuk data yang diproses Wav2Vec2
...
# ID 0 akan kita cadangkan untuk token <blank> CTC
# Jadi vocab asli kita (spasi, a-z) akan di-map ke 1-27
